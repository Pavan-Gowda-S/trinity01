  ...
  head: () => ({
    meta: [
      { title: "TRINITY — Predictive Cybercrime Intelligence" },
      {
        name: "description",
        content:
          "Sign in to the TRINITY prototype as Citizen, Police/LEA, Bank/FI, I4C or Admin. Predictive cash-out location and time-window intelligence on synthetic demo data.",
      },
...
const ROLES: { role: Role; blurb: string }[] = [
  { role: "citizen", blurb: "Report and track complaints" },
    ...
    <div className="flex min-h-screen items-center justify-center px-4 py-12">
      <div className="fade-up w-full max-w-md">
        ...
        <p className="mt-4 text-center text-[11px] leading-relaxed text-muted-foreground">
          Prototype only. No authentication, and no connection to NCRP, I4C, CFCFRMS, bank or police
          systems. All data shown is synthetic.
        </p>
      </div>
    </div>
  );
